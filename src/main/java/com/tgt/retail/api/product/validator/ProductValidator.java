...
public class ProductValidator implements Validator {
	...
	public boolean isValidProductId(String productId) {
		...
		try {
			...
			throw new InvalidInputException(
				new ResponseInfo(
					MessageConstants.INVALID_PRODUCT_ID_ERROR_CODE,
					MessageConstants.INVALID_PRODUCT_ID_ERROR_DESCRIPTION, 
	...
	public boolean isValidProductMatch(ProductPrice product, String productId) {
		...
		if (!isValidProductId(productId) || Long.parseLong(productId) != product.getProductId()) {
			...
			throw new InvalidInputException(
				new ResponseInfo(
					MessageConstants.MISMATCH_PRODUCT_ID_ERROR_CODE,
					MessageConstants.MISMATCH_PRODUCT_ID_ERROR_DESCRIPTION, 
					MessageConstants.RESPONSE_TYPE_ERROR)
				);
		}
		return valid;
	...
	public void validate(Object target, Errors errors) {
		...
		if (productPrice.getPrice() == null) {
			...
			throw new InvalidInputException(
			new ResponseInfo(
				MessageConstants.MISSING_PRODUCT_PRICE_ERROR_CODE,
				MessageConstants.MISSING_PRODUCT_PRICE_ERROR_DESCRIPTION, 
				MessageConstants.RESPONSE_TYPE_ERROR)
			);
		}
			...
			throw new InvalidInputException(
			new ResponseInfo(
				MessageConstants.INVALID_PRODUCT_PRICE_ERROR_CODE,
				MessageConstants.INVALID_PRODUCT_PRICE_ERROR_DESCRIPTION, 
				MessageConstants.RESPONSE_TYPE_ERROR)
			);
			...
			throw new InvalidInputException(
			new ResponseInfo(
				MessageConstants.MISSING_CURRENCY_ERROR_CODE,
				MessageConstants.MISSING_CURRENCY_ERROR_DESCRIPTION, 
				MessageConstants.RESPONSE_TYPE_ERROR)
			);
			...
			throw new InvalidInputException(
			new ResponseInfo(
				MessageConstants.INVALID_CURRENCY_ERROR_CODE,
				MessageConstants.INVALID_CURRENCY_ERROR_DESCRIPTION, 
				MessageConstants.RESPONSE_TYPE_ERROR)
			);
		}
	}
